        ...
        <Dialog as="div" className="relative z-50" onClose={onClose}>
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <Transition.Child
              ...
              leave="ease-in duration-200"
              leaveFrom="opacity-100 translate-y-0 sm:scaled-100"
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 text-left shadow-xl transition-all w-full sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="absolute right-0 top-0 hidden pr-4 pt-4 sm:block z-10">
                  <button
                    type="button"
                    className="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:rind-sky-500 focus:ring-offset-2"
                    onClick={onClose}
                  >
